...
<div class="profile">
	...
	{assign var="bVoteInfoEnabled" value=$LS->ACL_CheckSimpleAccessLevel($oConfig->GetValue('vote_state.user.na_required_level'), $oUserCurrent, $oUserProfile, 'user')}
	<div class="vote-profile">
		<div id="vote_area_user_{$oUserProfileId}" class="vote-topic
			...
			<span id="vote_total_user_{$oUserProfileId}" class="vote-count" data-count="{$iUserProfileCountVote}" data-target_id="{$oUserProfileId}" data-target_type="user">{$oUserProfile->getRating()}</span>
